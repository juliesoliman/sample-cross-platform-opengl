...
#ifndef _DEMO_TWEETS_HPP_
#define _DEMO_TWEETS_HPP_
...
namespace demo
{
    ...
    class Tweets : public graphics::app
    {
        glm::vec2 rotation;
    ...
    public:
        ...
        void render( float globalTime, float globalTimeDelta )
        {
            ...
            sphere.render( globalTime, &( Projection * View * Model )[0][0] );
        }
    };

    inline graphics::app *tweets_demo()
    {
        return dynamic_cast<graphics::app*>( new Tweets );
    }
}
