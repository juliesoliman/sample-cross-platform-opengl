...
void main()
{
    ...
    color.r = 0.5 * sin( 0.25 * ( time + position.x * 4.0 ) + position.y * 5.0 );
    color.b = 0.5 * cos( 0.25 * ( time + position.y * 8.0 ) + position.y * 2.0 );
    color.g = 0.5 * sin( 0.25 * ( time + position.x * 0.2 ) + position.y * 8.0 );
    color.a = 1.0;
